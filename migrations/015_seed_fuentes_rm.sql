...
VALUES
    (
        ...
        'rss',
        'B',
        'https://news.google.com/rss/search?q=Real+Madrid+fichaje+OR+transfer+OR+signing+2026&hl=es&gl=ES&ceid=ES:es',
        'es',
        'neutral',
        1.0, 1.0,
        60,
    ...
    (
        ...
        'rss',
        'B',
        'https://news.google.com/rss/search?q=%22Real+Madrid%22+transfer+target+OR+%22in+talks%22+OR+%22keen+on%22+OR+%22close+to%22+2026&hl=en&gl=US&ceid=US:en',
        'en',
        'neutral',
        1.0, 1.0,
        60,
